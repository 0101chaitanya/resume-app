      ...
      {!toggle ? (
        <div className="raw">
          <form>
            ...
            <Section2 state={tate} onChange={onChange.bind(this)} />
        ...
        <div className="preview">
          <div className="printPreview">
            <div className="part1">
              ...
              {(state.schoolName1 || state.schoolName2) && (
              ...
              {(state.organizationName1 || state.organizationName2) && (
              ...
              <p className="skillsSpec">{state.skills}</p>
              <section class="projectSpec">
                <ol>
                  {state.project1 && <li>{state.project1}</li>}
                  {state.project2 && <li>{state.project2}</li>}
                  {state.project3 && <li>{state.project3}</li>}
                </ol>
              </section>
            </div>
          </div>
