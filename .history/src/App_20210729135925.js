...
function App() {
  ...
  const onChange = (e) => {
    ...
    setState({
      ...
      [name]:
        name === "file"
          ? JSON.parse(URL.createObjectURL(e.target.files[0])).split(":")[1]
          : value,
    });
    console.log(JSON.parse(URL.createObjectURL(e.target.files[0])));
  };
          ...
          <div className="printPreview">
            <div className="part1">
              ...
              <section className="part1Right">
                <div>
                  <img src={state.file} alt="dummy" width="300" height="300" />{" "}
                  {state.file}
                </div>
              </section>
            </div>
